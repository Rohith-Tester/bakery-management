...
function fetch_order_with_items($pdo, $id) {
    ...
    return array(
        ...
        'customerAddress' => isset($o['customer_address']) ? $o['customer_address'] : '',
        'customerCity' => isset($o['customer_city']) ? $o['customer_city'] : '',
        'customerPhone' => isset($o['customer_phone']) ? $o['customer_phone'] : '',
        'deliveryNotes' => isset($o['delivery_notes']) ? $o['delivery_notes'] : '',
        'items' => $items,
        'total' => (float)$o['total'],
        'status' => $o['status'],
