-- Bake & Co Management — MySQL schema v2 (with address fields) + seed data
-- Import this file first: mysql -u root -p bakery_db < schema_v2.sql
...
-- ── Seed: Customers ──────────────────────────────────────────────────────
INSERT INTO customers (id, name, email, phone, address, city, postal_code, total_orders, total_spend) VALUES
(UUID(), 'Priya Sharma',     'priya@example.com',   '9876543210', '123 Bakers Lane', 'Mumbai', '400001', 14, 18200),
(UUID(), 'Ravi Menon',       'ravi@example.com',    '9876543211', '456 Cake Street', 'Bangalore', '560001', 9, 11500),
(UUID(), 'Ananya Krishnan',  'ananya@example.com',  '9876543212', '789 Sweet Ave', 'Delhi', '110001', 22, 28900),
(UUID(), 'Deepak Reddy',     'deepak@example.com',  '9876543213', '321 Pastry Road', 'Hyderabad', '500001', 7, 6720),
(UUID(), 'Meera Tiwari',     'meera@example.com',   '9876543214', '654 Donut Plaza', 'Pune', '411001', 5, 4100);
...
INSERT INTO orders (id, order_number, customer_id, customer_name, customer_address, customer_city, customer_phone, total, status, payment_method, created_at) VALUES
(@o1, 'ORD-001', @c1, 'Priya Sharma',    '123 Bakers Lane', 'Mumbai', '9876543210', 1440, 'delivered', 'online',  DATE_SUB(NOW(), INTERVAL 2 DAY)),
(@o2, 'ORD-002', @c2, 'Ravi Menon',      '456 Cake Street', 'Bangalore', '9876543211', 580,  'ready',     'offline', DATE_SUB(NOW(), INTERVAL 1 DAY)),
(@o3, 'ORD-003', @c3, 'Ananya Krishnan', '789 Sweet Ave', 'Delhi', '9876543212', 3200, 'baking',    'online',  DATE_SUB(NOW(), INTERVAL 1 HOUR)),
(@o4, 'ORD-004', @c4, 'Deepak Reddy',    '321 Pastry Road', 'Hyderabad', '9876543213', 960,  'pending',   'offline', DATE_SUB(NOW(), INTERVAL 30 MINUTE)),
(@o5, 'ORD-005', @c5, 'Meera Tiwari',    '654 Donut Plaza', 'Pune', '9876543214', 430,  'pending',   'offline', NOW());
